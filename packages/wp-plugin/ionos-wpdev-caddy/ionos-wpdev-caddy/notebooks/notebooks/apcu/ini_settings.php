...
$directives = [
    'apc.enabled', 'apc.shm_size', 'apc.shm_segments',
    'apc.entries_hint', 'apc.ttl', 'apc.gc_ttl',
    'apc.mmap_file_mask', 'apc.slam_defense', 'apc.enable_cli',
    'apc.use_request_time', 'apc.serializer', 'apc.coredump_unmap',
    'apc.preload_path',
];
...
if (\ini_get('apc.enabled')) {
    ...
    echo "\nCache Stats:\n";
    echo \str_repeat('-', 60) . "\n";
    printf("Entries: %d | Hits: %d | Misses: %d | Memory: %.2f%%\n",
        $info['num_entries'],
        $info['num_hits'],
        $info['num_misses'],
