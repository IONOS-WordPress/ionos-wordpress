...
- ca32297: BREAKING: upgrade pnpm from 9.15.9 to 11.22.0. Native Linux users not using the dev container must manually update their local pnpm install to match:
