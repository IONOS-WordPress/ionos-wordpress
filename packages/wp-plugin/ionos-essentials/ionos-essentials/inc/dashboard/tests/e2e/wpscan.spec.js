...
test.describe(
  'essentials:dashboard wpscan',
  {
    tag: ['@dashboard', '@wpscan'],
  },
  () => {
    test.beforeAll(async () => {
      execTestCLI(`
      wp --quiet eval 'set_transient("ionos_wpscan_issues", [["name"=>"Essentials","slug"=>"ionos-essentials","type"=>"plugin","score"=>8,"update"=>false,"path"=>"ionos-essentials/ionos-essentials.php"]]);' --skip-plugins --skip-themes
    `);
    });
