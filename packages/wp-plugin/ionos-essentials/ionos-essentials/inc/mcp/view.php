...
?>
          ...
          <div class="grid-col grid-col--12" id="ionos-essentials-mcp-info">
            ...
            <button class="button button--primary ionos-essentials-mcp-activate <?php echo (IONOS_ESSENTIALS_MCP_SERVER_ACTIVE) ? '' : 'hidden'; ?>" title=""><?php \esc_html_e('Generate application password for user', 'ionos-essentials'); ?></button>
          </div>
      </div>
          </section>
