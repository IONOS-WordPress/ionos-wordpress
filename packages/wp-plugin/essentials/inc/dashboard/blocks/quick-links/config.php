...
/*$links = [
  ...
  $blog_url . '/wp-admin/site-editor.php?postType=wp_navigation' => __('Edit site navigation', 'ionos-essentials'),
  $blog_url . '/wp-admin/site-editor.php?path=%2Fwp_global_styles' => __('Change styles, colours and font', 'ionos-essentials'),
  $blog_url . '/wp-admin/site-editor.php' => __('Edit Header', 'ionos-essentials'),
  $blog_url . '/wp-admin/site-editor.php' => __('Edit Footer', 'ionos-essentials'),
  $blog_url . '/wp-admin/plugin-install.php' => __('Add plugins', 'ionos-essentials'),
  $blog_url . '/wp-admin/upload.php' => __('Upload media files', 'ionos-essentials'),
];
$icons = [
  'file-text-16.svg',
  'helparticle-16.svg',
  'digitalisation-48.svg',
  'favstar-16.svg',
  'website-48.svg',
  'download-document-14.svg',
  'plus-16.svg',
  'upload-16.svg',
];*/
