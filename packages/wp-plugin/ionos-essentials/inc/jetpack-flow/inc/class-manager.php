...
use ionos\essentials\jetpack_flow\Loginredirect;
use ionos\essentials\jetpack_flow\HiddenAdminPage;
...
class Manager {
	...
	public static function init() {
		...
		$sso_actions = [
			'ionos_oauth_authenticate',
			'ionos_oauth_register',
		];
	...
	public static function prevent_my_jetpack_redirect( $location ) {
		...
		if ( isset( $query_params['page'] ) && $query_params['page'] === 'my-jetpack' ) {
