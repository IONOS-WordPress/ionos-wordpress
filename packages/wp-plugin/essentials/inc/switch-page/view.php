...
$configs  = array(
	'ionos' 	=> array( 'color' => '#0b2a63', 'logo' => 'ionos.svg' ),
	'fasthosts' => array( 'color' => '#031A4A', 'logo' => 'fasthosts.svg' ),
	'arsys' 	=> array( 'color' => '#000016', 'logo' => 'arsys.svg' ),
	'piensa' 	=> array( 'color' => '#010101', 'logo' => 'piensa.svg' ),
	'strato' 	=> array( 'color' => '#FF8800', 'logo' => 'strato.svg' ),
	'udag' 		=> array( 'color' => '#092850', 'logo' => 'udag.svg' ),
);
    ...
    <div class="container">
        ...
        <div class="option"
          ...
          <a href="<?php echo esc_attr( \admin_url() . 'admin.php?page=extendify-launch' ); ?>" class="link-btn">
            <div class="option-content">
              ...
              <img src="<?php echo esc_url( \plugins_url( 'assets/artificial-intelligence.png', __FILE__ ) ); ?>"
                   alt="Artificial Intelligence Illustration"/>
              <h3>
                <?php esc_html_e( 'With AI', 'ionos-assistant' ); ?>
              </h3>
              <p>
                <?php esc_html_e( 'Automatic website creation based on your preferences and requirements. Including ready-to-go copy and images.', 'ionos-assistant' ); ?>
              </p>
              <p style="font-weight:700">
                <?php esc_html_e( '100% WordPress', 'ionos-assistant' ); ?>
              </p>
            </div>
          </a>
        </div>
        <div class="option">
          <a href="<?php echo esc_attr( \admin_url() . 'admin.php?page=extendify-assist#dashboard' ); ?>" class="link-btn">
            <div class="option-content">
              <img src="<?php echo esc_url( \plugins_url( 'assets/user-interface.png', __FILE__ ) ); ?>"
                   alt="User Interface Illustration"/>
              <h3>
                <?php esc_html_e( 'Do it yourself', 'ionos-assistant' ); ?>
              </h3>
              <p>
                <?php esc_html_e( 'You decide how to create your website. No worries, you can also start the AI creation from the WordPress Dashboard later.', 'ionos-assistant' ); ?>
              </p>
            </div>
          </a>
        </div>
      ...
      <div class="checkbox-option">
        ...
        // translators: %1$s, %2$s, %3$s and %4$s are placeholders for html tags.
          esc_html__( 'By using AI features you agree to the OpenAI %1$sTerms of Use%2$s and %3$sPrivacy Policy%4$s', 'ionos-assistant' ),
