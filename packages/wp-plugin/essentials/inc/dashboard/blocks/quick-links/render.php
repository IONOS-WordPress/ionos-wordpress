  ...
  echo '
    <div class="wp-block-column quick-links" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
      ...
      foreach ($links as $url => $anchor) {
        printf('<div class="wp-block-group element" style="display:flex;min-height:50px;margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:20px">
