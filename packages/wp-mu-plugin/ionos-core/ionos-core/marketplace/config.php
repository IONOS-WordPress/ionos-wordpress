...
return [
  'ionos_plugins' => [
    ...
    'ionos-sso' => [
      ...
      'name'              => 'IONOS Login',
      'short_description' => __('IONOS Login allows you to log in with your IONOS customer ID and password through the IONOS Control Panel login page. You then have an active session in both your WordPress and your Control Panel and can jump easily from one to the other.', 'ionos-core'),
      'version'           => 'latest',
      'author'            => '<a href="https://www.ionos-group.com/brands.html">IONOS</a>',
      'slug'              => 'ionos-sso',
      'icons'             => [
