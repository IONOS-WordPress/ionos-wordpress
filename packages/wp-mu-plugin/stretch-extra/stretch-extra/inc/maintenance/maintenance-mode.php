 ...
 *
 * This file is symlinked to wp-content/stretch-extra-maintenance-mode.php on
...
\add_action('muplugins_loaded', function (): void {
    // Never block WP-CLI — its SAPI is 'cli', not 'fpm-fcgi'
    ...
    \wp_die(
      ...
      args:    ['response' => 503, 'additional_headers' => ['Retry-After' => (string) MAINTENANCE_EXPIRY_SECONDS]],
    );
  }
);
