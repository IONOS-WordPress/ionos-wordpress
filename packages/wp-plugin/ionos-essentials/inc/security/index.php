...
const IONOS_SECURITY_FEATURE_OPTION_HUB_AS_START_PAGE    = 'IONOS_SECURITY_FEATURE_OPTION_HUB_AS_START_PAGE';
...
const IONOS_SECURITY_FEATURE_OPTION_DEFAULT = [
  ...
  IONOS_SECURITY_FEATURE_OPTION_HUB_AS_START_PAGE    => true,
];
