...
Ran `scripts/_prepare.sh` for real: generated `.vscode/settings.json` now contains `"./mnt/wordpress-core/WordPress-WordPress-7.0.3"` - confirmed that directory exists and contains real WordPress core (`wp-includes/version.php` present).
